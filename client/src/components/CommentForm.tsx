import { Code, Send, User } from "lucide-react";
...
function CommentForm({ isSubmitting, onSubmit, isAuthenticated = false }: CommentFormProps) {
    ...
    if (!isAuthenticated) {
        return (
            <div className="mb-8">
                <div className="bg-[#0a0a0f] rounded-xl border border-[#ffffff0a] overflow-hidden p-4">
