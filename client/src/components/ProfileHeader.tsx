import { Activity, Code2, Star, Timer, TrendingUp, Trophy, User as UserIcon, Zap } from "lucide-react";
...
// Mock starred snippets count
const starredSnippetsCount = 3;
        ...
        >
            ...
            <div className="relative flex items-center gap-8">
                <div className="relative group">
                    <div
                        className="absolute inset-0 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full blur-xl opacity-50 group-hover:opacity-75 transition-opacity"
                    />
                    <img
                        src={user.imageUrl}
                        alt="Profile"
